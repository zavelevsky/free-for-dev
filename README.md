...
## Automated Browser Testing
  ...
  * [Applitools.com](https://applitools.com/?utm_source=github&utm_medium=free-for-dev) — smart visual validation for web, native mobile and desktop apps. Integrates with almost all automation solutions (like Selenium and Karma) and remote runners (Sauce Labs, Browser Stack). Free for open source. A free tier for a single user with limited checkpoints per week.
